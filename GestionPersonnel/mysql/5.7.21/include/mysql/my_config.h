...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql/5.7.21"
#define SHAREDIR "/usr/local/Cellar/mysql/5.7.21/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql/5.7.21"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql/5.7.21/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql/5.7.21"
#define PLUGINDIR "/usr/local/Cellar/mysql/5.7.21/lib/plugin"
...
#define PACKAGE_STRING "MySQL Server 5.7.21"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.7.21"
#define VERSION "5.7.21"
